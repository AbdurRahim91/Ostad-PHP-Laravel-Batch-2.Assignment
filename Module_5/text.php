...
if(isset($_POST['submit'])){
	$id = $_POST['id'];
	$nama = $_POST['edit_user_name'];
	$email = $_POST['edit_email'];
	$role = $_POST['edit_role'];
	$dataLast = edit($_POST['id']);
	$content = str_replace($dataLast,"$id|$nama|$email|$role|",file_get_contents(DB));
        ...
        <div class="row">
            <div class="col-md-10 mx-auto mt-5">
                <div>
                    ...
                    <h3 class="text-center alert-info">Role management page</h3>
                            ...
                            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                                ...
                                <div class="card-body p-5">
                                    <form action="update.php" method="POST">
                                        ...
                                        <input type="text" id="edit_user_name" name="edit_user_name" class="form-control" value="<?=$nama;?>" placeholder="Enter User Name" />
                                        <label class="form-label" for="edit_user_name">User Name</label>
                                        </div>                  

                                    <div class="form-floating mb-4">
                                        <input type="email" id="edit_email" name="edit_email" class="form-control " value="<?=$email;?>" placeholder="Your Email" />
                                        <label class="form-label" for="edit_email">User Email</label>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
